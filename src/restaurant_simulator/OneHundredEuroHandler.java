...
/**
 * Classe cento euro handler
 * 
 * @author Danilo Dolce e Simone Contini
 * @version 1.0
 */
public class OneHundredEuroHandler implements IBanknoteHandler{
    ...
    public void handlerRequest(Banknote banknote) {
        if (banknote.getValue()>=100) {
            ...
            double valore = (double) Math.round((banknote.getValue()-100)*100)/100;
            banknote.setValue(valore);
            banknote.addBanknote("100 euro");
