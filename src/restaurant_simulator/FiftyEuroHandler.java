...
/**
 * Classe cinquanta euro handler
 * 
 * @author Danilo Dolce e Simone Contini
 * @version 1.0
 */
public class FiftyEuroHandler implements IBanknoteHandler{
    ...
    public void handlerRequest(Banknote banknote) {
        if (banknote.getValue()>=50) {
            ...
            double valore = (double) Math.round((banknote.getValue()-50)*100)/100;
            banknote.setValue(valore);
            banknote.addBanknote("50 euro");
