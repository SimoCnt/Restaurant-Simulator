...
/**
 * Classe dieci euro handler
 * 
 * @author Danilo Dolce e Simone Contini
 * @version 1.0
 */
public class TenEuroHandler implements IBanknoteHandler {
    ...
    public void handlerRequest(Banknote banknote) {
        if (banknote.getValue()>=10) {
            ...
            double valore = (double) Math.round((banknote.getValue()-10)*100)/100;
            banknote.setValue(valore);
            banknote.addBanknote("10 euro");
