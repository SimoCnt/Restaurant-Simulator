...
/**
 * Classe venti euro handler
 * 
 * @author Danilo Dolce e Simone Contini
 * @version 1.0
 */
public class TwentyEuroHandler implements IBanknoteHandler {
    ...
    public void handlerRequest(Banknote banknote) {
        if (banknote.getValue()>=20) {
            ...
            double valore = (double) Math.round((banknote.getValue()-20)*100)/100;
            banknote.setValue(valore);
            banknote.addBanknote("20 euro");
