...
/**
 * Classe cinque euro handler
 * 
 * @author Danilo Dolce e Simone Contini
 * @version 1.0
 */
public class FiveEuroHandler implements IBanknoteHandler {
    ...
    public void handlerRequest(Banknote banknote) {
        if (banknote.getValue()>=5) {
            ...
            double valore = (double) Math.round((banknote.getValue()-5)*100)/100;
            banknote.setValue(valore);
            banknote.addBanknote("5 euro");
